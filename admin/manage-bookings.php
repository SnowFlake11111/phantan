...
<html>
<head>
<title>TMS | Quản lý đặt vé Admin</title>
...
{
echo "Bạn đã hủy vé lúc " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='u')
{
echo "Người dùng đã hủy vé lúc" .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Đã hủy</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt vé?')" >Cancel</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt vé?')" >Xác nhận</a></td>
<?php }?>
