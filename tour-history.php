...
{
$error="Bạn không thể hủy đặt vé 24h trước khi khởi hành";
}
}
}
}
...
<meta name="keywords" content="Hệ thống quản lý du lịch bằng PHP" />
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Lịch sử hành trình của tôi</h3>
		<form name="chngpwd" method="post" onSubmit="return valid();">
		 <?php if($error){?><div class="errorWrap"><strong>CÓ LỖI</strong>:<?php echo htmlentities($error); ?> </div><?php } 
...
{
echo "QTV đã hủy lúc" .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Đã hủy</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy?')" >Hủy</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
